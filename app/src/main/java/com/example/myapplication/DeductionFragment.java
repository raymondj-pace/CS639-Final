...
public class DeductionFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
         ...
         */
        view.findViewById(R.id.DeductFunds_BtnOk).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (deductingFunds(view)) {
         ...
         */
        view.findViewById(R.id.DeductFunds_BtnCancel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                NavHostFragment.findNavController(DeductionFragment.this)
                        .navigate(R.id.action_Deduction_to_Main);
    ...
    public boolean deductingFunds(View view) {
        ...
        if ( aAmount.isEmpty() || aDescription.isEmpty()) {
            ...
            MoneyTransaction transaction = new MoneyTransaction(0, dateStr, amount, aDescription);
